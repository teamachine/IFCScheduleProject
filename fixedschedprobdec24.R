#changed elemlistindex to elemindex in verification 1 bc it was a mistake and it still works.
#
require(nsga2R)
...
# prctbl <- as.data.frame(read_xlsx("prec_matrix_2.xlsx", sheet = "matrix")) #reading original matrix
# prctbl
# 
# # 
# prctbl1 <- data.frame(
...
t<- as.data.frame(read_xlsx("teams.xlsx", sheet = "demoteams1"))
...
schedprob=nsga2(funct,nogenes,2,#constraints=constrX, cdim=2,
                ...
                popsize = 4, generations = 4,vectorized=FALSE)
